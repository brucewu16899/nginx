...
sudo apt-get install -y libxml2-dev libbz2-dev libcurl4-openssl-dev libmcrypt-dev libmhash2 libmhash-dev libpcre3 libpcre3-dev make build-essential libxslt1-dev git unzip libgd2-xpm-dev libgeoip-dev libpam-dev libgoogle-perftools-dev  lua5.1 liblua5.1-0 liblua5.1-0-dev
echo "done"
sleep 2
